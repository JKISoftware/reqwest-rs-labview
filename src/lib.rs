...
pub use ffi::request::{
    request_cancel, request_destroy, request_read_error_kind, request_read_error_message,
    request_read_error_source, request_read_error_url, request_has_error, request_is_complete,
